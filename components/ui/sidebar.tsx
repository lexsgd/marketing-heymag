...
>(
  (
    ...
    }, [isMobile, open, collapsible, setOpen])

    const handleMouseLeave = React.useCallback(() => {
      if (!isMobile && hoverExpandedRef.current && open) {
    ...
    React.useEffect(() => {
      if (open && !hoverExpandedRef.current) {
        // Sidebar was manually opened, reset hover flag
        hoverExpandedRef.current = false
      }
    }, [open])
